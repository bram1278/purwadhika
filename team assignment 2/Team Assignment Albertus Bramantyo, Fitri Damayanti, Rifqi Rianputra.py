...
while cek != opsiuser:
    ...
    if opsi == '1':
        ...
        opsi2 = True
        while opsi2:
            pilih2 = input('Masukkan "kata" untuk akses morse atau "kembali" untuk ke menu utama:').lower()
            if pilih2 == "kata":
        ...
        print('\n=== KONVERSI ROMAWI ===')
        opsi4 = True
        pilih4 = input('Masukkan kata "angka" untuk akses romawi atau "kembali" untuk ke menu awal: ').lower()
        if pilih4 == 'angka':
        ...
        userinputdays = str(input("Masukkan nama hari:")).lower()
        if userinputdays in days:
            if (userinputdays == "senin"):
                convert = 0
            elif (userinputdays == "selasa"):
                convert = 1
            elif (userinputdays == "rabu"):
                convert = 2
            elif (userinputdays == "kamis"):
                convert = 3
            elif (userinputdays == "jum'at"):
                convert = 4
            elif (userinputdays == "sabtu"):
                convert = 5
            elif (userinputdays == "minggu"):
                convert = 6
            else:
                print("Mohon masukkan nama hari yang benar \nCatatan: Gunakan hari jum'at atau Jum'at, bukan jumat atau Jumat")
                
            userinputduration = int(input("Masukkan jumlah hari yang akan dihitung: "))
            ...
            print (f'{userinputduration} hari terdiri dari {tahun} tahun, {bulan} bulan, {minggu} minggu \ndan perhitungan tersebut akan jatuh pada hari {converteddays}')
        ...
        while opsi10:
            ...
            if pilih10 == '1':
                ...
                try:
                    inputuser = int(input('Silakan masukkan angka yang ingin dikonversi menjadi urutan Fibonacci: '))
                    hasil = []
                    if inputuser <= 0:
                        print ('Mohon masukkan angka yang lebih besar')
                    else:
                        ...
                        for i in range(0,inputuser):
                            hasil.append(fibnum(i))
                        print(f'Urutan Fibonacci {inputuser} adalah {hasil} \n')
                except:
        ...
        print('\n=== CRUD ===')
        fruits = ['apel','pisang','pir','ceri','kiwi','jeruk','semangka']
        vegetables = ['mentimun','kubis','kol','brokoli','bayam', 'wortel']
        instants = ['daging kornet','mie instan','nugget','sarden','spam', 'sosis']
        opsi12 = True
        while opsi12:
            print('\n### MENU STOK ###')
            print('[1] MELIHAT ISI STOK \n[2] MENAMBAH ISI STOK \n[3] MENGHAPUS ISI STOK \n[4] MENGEDIT ISI STOK \n[5] KEMBALI KE MENU UTAMA')
            opsiuser = (input('masukkan pilihan [1/2/3/4/5]: '))
            if opsiuser == '1':
                print('=== MELIHAT ISI STOK ===')
                print('Buah-buahan: ',fruits) 
                if fruits == []: # jika isi list dari fruits kosong
                    print('Stok buah-buahan kosong') 
                print('Sayuran: ', vegetables) 
                if vegetables == []: # jika isi list dari vegetables kosong 
                    print('Stok sayuran kosong')
                print('Makanan Instan:', instants)
                if instants == []: # jika isi list dari instants kosong 
                    print('Stok makanan instan kosong')

            elif opsiuser == '2': # jika user memilih opsi untuk menambahkan data baru ke sebuah list
                print('=== MENAMBAH ISI STOK ===')
                var = input('[1] Buah-buahan \n[2] Sayuran \n[3] Makanan Instan \n[1/2/3]:') # user memilih input list mana yang akan ditambahkan data baru
                if var == '1':
                    edit = input('Mohon masukkan data yang akan ditambahkan:') # mengeset variabel input bernama edit
                    ...
                    for n in range(0,i+1): # mengeset looping for dengan variabel n sebagai variabel penentu dan batasnya ditentukan variabel i
                        if n == i: # jika n telah bernilai sama dengan i
                            ...
                            print('Data telah ditambahkan') # memprint tanda notif bahwa input user berhasil ditambahkan ke list
                            print('Buah-buahan:',fruits) # memprint list yang baru
                            ...
                            create = str(input('Data tersebut sudah ada didalam list, apakah Anda ingin menambahkannya? (Y/N):')) # buat variabel input create yang menentukan apakah user tetap ingin menambahkan atau tidak
                            ...
                            if create2 == 'y': # jika user menginput 'y' atau 'Y'
                                ...
                                print('Data tidak ditambahkan') # memprint tanda notif bahwa input user tidak ditambahkan ke list
                                print('Buah-buahan:',fruits) # memprint list yang tidak ditambahkan masukan user
                                break # mengakhiri for looping
                            else: # jika input user tidak sama dengan 'y', 'Y', 'n', atau 'N'
                                print('Pilihan yang Anda masukkan salah, mohon coba lagi') # memprint tanda notif bahwa input user salah
                                break # mengakhiri for looping
                elif var == '2': # sama dengan kode untuk fruits, tetapi variabel fruits diganti menjadi vegetables
                    edit = input('Mohon masukkan data yang akan ditambahkan:')
                    editx = edit.lower()
                    i = len(vegetables)
                    for n in range(0,i+1):
                        if n == i:
                            ...
                            create = str(input('Data tersebut sudah ada didalam list, apakah Anda ingin menambahkannya? (Y/N):'))
                            ...
                            if create2 == 'y':
                                ...
                                print('Pilihan yang Anda masukkan salah, mohon coba lagi')
                                break
                elif var == '3': # sama dengan kode untuk fruits, tetapi variabel fruits diganti menjadi instants
                    edit = input('Mohon masukkan data yang akan ditambahkan:')  # mengeset variabel input bernama edit
                    editx = edit.lower() # variabel input edit yang di-lowercase
                    ...
                    print('Maaf, data tersebut tidak ada dalam stok')

            elif opsiuser == '3': # opsi untuk menghapus isi list berdasarkan input user
                print('=== MENGHAPUS ISI STOK ===')
                var = input('[1] Buah-buahan \n[2] Sayuran \n[3] Makanan Instan \n[1/2/3]:') # user memasukkan input list mana yang isinya akan dihapus
                if var == '1':
                    x = input('[1] Menghapus seluruh stok \n[2] Menghapus data dalam stok \n[1/2]:')
                    if x == '1':
                        fruits.clear()
                        print('Buah-buahan:', fruits)
                    elif x == '2':
                        ...
                        edit = input('Masukkan data yang akan dihapus: ') # input yang dimasukkan user
                        ...
                        while n <= j: # while digunakan karena variabel pembatas loop dapat disesuaikan dengan kebutuhan, berbeda dengan for ... in ... yang pembatas loopnya fixed
                            if editx == fruits[n]: # mengecek apakah input user ada di index dalam daftar
                                ...
                                print('Data yang Anda masukkan tidak ada dalam stok') # jika kondisi memenuhi, berarti tidak ada perubahan daftar; dengan kata lain, input tidak eksis di daftar
                ...
                print('=== MENGEDIT ISI STOK ===')
                var = input('[1] Buah-buahan \n[2] Sayuran \n[3] Makanan Instan \n[1/2/3]:') # user memasukkan input list mana yang isinya akan diubah
                if var == '1': # jika user memilih list fruits
                    upd = input('Mohon masukkan data yang akan diedit: ').lower() # user memasukkan nama dari list fruits yang akan digantikan
                    i = len(fruits) # menghitung berapa banyak isi list
                    for n in range(0,i+1): # mengeset looping for dengan variabel n sebagai variabel penentu dan batasnya ditentukan variabel i
                        if n == i: # jika n telah bernilai sama dengan i
                            print('Data yang Anda masukkan tidak ada dalam stok') # memprint notif bahwa input nama lama yang akan digantikan tidak ada di dalam daftar list
                            ...
                            upd1 = input('Masukkan nama yang baru untuk data tersebut: ').lower() # user memasukkan nama baru yang akan menggantikan isi list lama
                            fruits[n] = upd1 # isi index dari list akan diubah menjadi nama yang baru
                            break # mengakhiri looping for
                    print('Buah-buahan: ',fruits)    
                
                elif var == '2': # sama dengan kode untuk fruits, tetapi variabel fruits diganti menjadi vegetables
                    upd = input('Mohon masukkan data yang akan diedit: ').lower()
                    i = len(vegetables)
                    for n in range(0,i+1):
                        if n == i:
                            print('Data yang Anda masukkan tidak ada dalam stok')
                            break
                        elif upd == vegetables[n]:
                            upd1 = input('Masukkan nama yang baru untuk data tersebut: ').lower()
                            vegetables[n] = upd1
                            break
                    print('Sayuran: ',vegetables)  
                elif var == '3': # sama dengan kode untuk fruits, tetapi variabel fruits diganti menjadi instants
                ...
                print('Pilihan yang Anda masukkan salah! Pilihan hanya 1 - 5')
