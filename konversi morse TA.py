...
def morsekehuruf(i): # input adalah list yang isinya hasil pecahan kode morse
    ...
    for a in range(0,len(i)):
        if i[a] not in morse:
            ...
            alnum1[a] = alnum[morse.index(i[a])] # jika perintah ini dijalankan saat alnum1 diset [], akan didapat pesan "index out of range"
    return alnum1
